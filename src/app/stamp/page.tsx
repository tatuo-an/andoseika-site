...
export const metadata: Metadata = {
    title: {
        absolute: "あんどーのスタンプ工房｜写真から、世界に1つのLINEスタンプ",
    },
    description:
        "お子さん・ご家族・ペットの写真から、オリジナルのLINEスタンプを作ります。写真を送っていただくだけ。静止8個2,000円〜。鳥取で農業と養蜂をやっている安藤が、1件ずつ丁寧に作ります。",
    openGraph: {
        title: "あんどーのスタンプ工房｜写真から、世界に1つのLINEスタンプ",
        description:
...
const FAQ_ITEMS = [
    {
        ...
        a: "スタンプは基本的に非公開（限定公開）設定で申請します。LINEストアの検索には出てこない設定です。ただし、URLを直接知っている人はアクセスできてしまうため、完全に外部から見られない状態にしたい場合は別途ご相談ください。写真そのものは制作以外の目的では使いません。",
    },
    {
    ...
    {
        q: "納期はどれくらいかかりますか",
        a: "写真を受け取ってから完成・申請までは、目安として即日〜2日ほどです。そこからLINE側の審査に数日〜1週間ほどかかります。この審査の時間はこちらでは短縮できません。",
    },
    {
        q: "修正は何回できますか",
    ...
    {
        q: "支払いのタイミングはいつですか",
        a: "申請前の前払いをお願いしています。現金・PayPay・銀行振込・楽天ペイに対応しています。万一LINE側の審査に通らなかった場合は、全額返金または作り直しで対応します。",
    },
    {
                    ...
                    <div className="container mx-auto px-4 md:px-6 text-center max-w-2xl">
                        ...
                        <div className="mt-10 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-sm opacity-85">
                            <span className="inline-flex items-center gap-1">
                                <ShieldCheck className="h-4 w-4" /> 非公開設定で申請
                            </span>
                            <span className="inline-flex items-center gap-1">
