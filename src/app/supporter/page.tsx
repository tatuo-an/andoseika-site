                ...
                <div className="container mx-auto px-4 md:px-6 max-w-3xl">
                    ...
                    <div className="space-y-4">
                        {[
                            ...
                            {
                                q: "契約期間と更新はどうなりますか？",
                                a: "契約期間は入会日から1年間です。自動更新・自動課金はありません。期限が近づくとメールまたはLINEでご案内しますので、継続をご希望の場合はマイページから更新手続きをお願いします。更新されない場合は期間満了で特典が終了し、以後の請求はありません。",
                            },
                            {
                                q: "途中で解約・返金はできますか？",
                                a: "解約のための手続きは不要です。更新手続きをされなければ、契約期間の満了をもって終了し、以後の請求はありません。更新のご案内はマイページからいつでも停止できます（手数料なし）。契約終了後に一般会員へ戻り、アカウントと保有ポイントはそのまま維持されます。年会費お支払い後の利用者都合による途中解約・日割り・月割り返金は承っておりませんが、二重決済・誤請求・本人未承諾の決済・当方都合の提供停止などの場合は確認の上で返金いたします。農園パートナーの年2回の詰め合わせは、解約後も契約期間中に予定された分は引き続き送料込みで発送します。",
                            },
                        ].map((item, i) => (
                            <details
                                key={i}
        ...
        >
            ...
            <div className={`bg-white flex-1 ${popular ? "p-8 md:p-10" : "p-6 md:p-8"}`}>
                ...
                <p className="text-xs text-stone-400 text-center leading-relaxed mb-3">
                    契約期間は1年間です。継続はご案内メール／マイページからの更新手続き制で、自動課金はありません。<br />
                    マイページから更新案内を停止できます。
                </p>
                {isCurrent ? (
