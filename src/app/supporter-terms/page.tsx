...
export const metadata: Metadata = {
  ...
  description: "安藤青果の農家サポーター制度（住民票）に関する会員規約です。契約期間・更新手続き・解約・お届け物の内容についてご確認ください。",
};
...
const sections: { heading: string; items: (string | { text: string; sub?: string[] })[] }[] = [
  ...
  },
  {
    heading: "契約期間と更新",
    items: [
      "契約期間は入会日から1年間です。当制度に自動更新・自動課金はありません。契約期間が終了すると、サポーター特典は自動的に終了します。",
      "継続をご希望の場合は、契約期間終了前にマイページから更新手続き（年会費のお支払い）をお願いします。更新手続きが完了すると、契約期間が1年間延長されます。",
      "更新時期が近づくと（30日前・7日前）、メールまたはLINEで更新のご案内をお送りします。",
    ],
  },
  {
    heading: "次回更新日・更新額の確認",
    items: [
      "次回更新日はマイページ「サポーター」タブからご確認いただけます。",
      "更新時の年会費はご加入中のプランの年会費と同額です（プラン変更がない場合）。",
      "料金改定が行われる場合は、次回更新日の30日前までにメールおよびサイト上でご案内します。",
      "更新手続きをされない限り、年会費が請求されることはありません。",
    ],
  },
  {
    heading: "更新しない場合・更新案内の停止",
    items: [
      "更新をご希望でない場合、特別な解約手続きは不要です。契約期間の満了をもって特典は終了し、以後の請求はありません。",
      "更新のご案内が不要な場合は、マイページ「サポーター」タブ →「更新案内を停止する」からいつでも停止できます（手数料なし）。",
      "更新案内を停止しても、現在の契約期間終了日まではすべての特典・割引・限定商品購入をご利用いただけます。",
  ...
  },
  {
    ...
    items: [
      ...
      "変更内容に同意いただけない場合は、次回の更新手続きを行わないことで契約を終了できます。",
