...
const sections: { heading: string; items: string[] }[] = [
  ...
  },
  {
    ...
    items: [
      "投稿いただいた写真・文章は、安藤青果の公式サイト（商品ページ・TOPページ等）や公式SNSアカウントでの通常の紹介に利用する場合があります。これは会員規約上の許諾範囲です。",
      "ご紹介の際は、投稿時に登録いただいたニックネームまたは「@ユーザー名」を明記します。本名やメールアドレスを掲載することはありません。",
      "有料広告・チラシ・商品パッケージ等への利用（商業的二次利用）を行う場合は、改めて投稿者に個別にご連絡し、同意を得た上で使用します。",
      "公式SNSでご紹介した投稿が広告として使用される場合は、「#PR」「#広告」等の表示を行います。",
  ...
  },
  {
    heading: "投稿ポイントの付与条件",
    items: [
      "安藤青果の食材を使った料理写真を投稿すると、ポイントを付与します。初めての投稿は100pt、以降は月1回まで50ptです。",
      "ポイントは投稿内容の良し悪しに関わらず付与します。特定の評価・感想を条件にしません。",
