...
const pages = [
  {
    ...
    href: "/",
    emoji: "🏠",
    description: "安藤青果のトップページです。旬の商品やおすすめ商品を確認できます。最新情報は公式LINEでお届けしています。",
    features: ["旬の商品・おすすめ商品の確認", "みんなの料理投稿", "各ページへのナビゲーション"],
  },
  {
    name: "商品一覧",
    href: "/products",
    emoji: "🥬",
    description: "白ネギ・長芋・梨・はちみつ・らっきょうなど、安藤青果の商品を購入できます。会員登録なしでも購入できます。",
    features: ["会員登録なしでも購入可能", "会員登録するとポイントが貯まる・お気に入り登録ができる", "カートに入れてまとめて注文"],
  },
  {
    name: "みんなの料理",
    href: "/community",
    ...
    features: ["料理写真の投稿（会員限定）", "投稿するとポイントがもらえる（月1回まで）", "いいね・コメント・レシピの保存"],
    needsLogin: true,
  },
  {
    name: "体験・予約",
    ...
    features: ["体験プランの確認", "日程を選んで予約（会員登録が必要）", "予約履歴の確認"],
    needsLogin: true,
  },
  {
    name: "サポーター募集",
    href: "/supporter",
    emoji: "💚",
    description: "安藤青果を応援するサポーター会員になると、割引・ポイント特典が受けられます。実りサポーターには年1回、農園パートナーには年2回、旬の詰め合わせを送料込みでお届けします。",
    features: ["会員割引・ログインポイント特典", "実りサポーター：年1回、農園パートナー：年2回の旬の詰め合わせ（送料込み）", "サポーター限定商品の購入"],
    needsLogin: true,
  },
  {
    name: "業務用・卸",
          ...
          <section className="mb-12">
            ...
            <div className="bg-white rounded-2xl shadow-sm p-6 mb-4">
              <p className="text-stone-600 text-sm mb-6">
                会員登録は<strong>無料</strong>です。パスワードの設定は不要。GoogleまたはLINEアカウントで簡単に登録できます。
              </p>

              {/* LINE推奨バッジ */}
              <div className="bg-[#06C755]/10 border border-[#06C755]/30 rounded-xl p-4 mb-4">
                <div className="flex items-center gap-2 mb-2">
                  <div className="w-5 h-5 bg-[#06C755] rounded-sm flex items-center justify-center shrink-0">
                    <span className="text-white text-xs font-bold">L</span>
                  </div>
                  <span className="font-bold text-stone-800">LINEでの登録がおすすめ</span>
                  <span className="text-xs bg-[#06C755] text-white font-bold px-2 py-0.5 rounded-full">推奨</span>
                </div>
                <p className="text-sm text-stone-600 mb-3">
                  LINEで登録すると、注文確認や発送通知をLINEで受け取れます。メールの見逃しがなく便利です。
                </p>
