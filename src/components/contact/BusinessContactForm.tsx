                    ...
                    <div className="space-y-7">
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <label className="flex items-center gap-3 cursor-pointer">
                                ...
                                <span className="text-sm text-stone-700">当社サイトの「お取引先一覧」への掲載に同意する<span className="text-xs text-stone-400 ml-1">（店名・業種・住所・紹介文・Webサイト・お店の写真を掲載する場合があります。個人情報は掲載しません）</span></span>
                            </label>
                        </div>
