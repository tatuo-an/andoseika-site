export const TIERS = {
  ...
  minori:   { name: "実りサポーター",   price: 5000,  loginPt: 3, birthdayPt: 1500, discountRate: 0.05 },
  partner:  { name: "農園パートナー",   price: 10000, loginPt: 5, birthdayPt: 3000, discountRate: 0.08 },
} as const;
